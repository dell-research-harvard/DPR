...
n_random_papers = 100
path_pattern = '/mnt/data02/retrieval/preprocess/all_scans_dbx_text_files_1968_full_210929/**/ocr_*'
...
for paper in random_papers:
    ...
    with open(f"/mnt/data02/retrieval/retrieval_test/100_full_paper_samp_full_210929/out_file_{paper}.json", "w") as writer:
